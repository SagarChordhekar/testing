...
*/
 ...
 // console.log(arr3);
    ...
    //     this.outputData.push({
    //       id: arr3[i].id, sourceName: arr3[i].sourceName, sfieldName: arr3[i].sfieldName, sdataType: arr3[i].sdataType, targetName: arr3[i].targetName, tfieldName: arr3[i].tfieldName, tdataType: arr3[i].tdataType, urgencyName: arr3[i].urgencyName, descriptionName: arr3[i].descriptionName, directRowNo: "", sourceFieldPath: "", sourceFieldName: "", tfieldNameMapping: "", datatypeVerified: "", backgroundColor: "true"
    //     })
    //     name = '';
    //   }
    //   else {
    //     this.outputData.push({
    //       id: arr3[i].id, sourceName: "", sfieldName: "", sdataType: "", targetName: arr3[i].targetName, tfieldName: arr3[i].tfieldName, tdataType: arr3[i].tdataType, urgencyName: "", descriptionName: "", directRowNo: "", sourceFieldPath: "", sourceFieldName: "", tfieldNameMapping: "", datatypeVerified: "", backgroundColor: "true"
    //     })
    //   }
    // }
    // console.log(" this.requestData", this.requestData);
    // console.log("------- requestData for Response ------")

     // var yamlObject = {
    //     'params': flattenData,
    //     'templateName': 'template.yaml',
    //     'fileName': 'icici1.yaml',
    //     'username': 'akshay',
    //     'orgName': 'cateina'
    // }
