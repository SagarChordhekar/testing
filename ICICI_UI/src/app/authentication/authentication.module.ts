...
@NgModule({
  ...
  providers: [
    MyProfileService,MakerDetailsService ,MakerService, AppDetailsService, ProductPageService, LoginService, SignupService, LandingService, ECollectionService, HomePageService, mappingService,
    AppStatusService,CheckerDetailsService,CMSComponentService,MakerDetailsPageService
