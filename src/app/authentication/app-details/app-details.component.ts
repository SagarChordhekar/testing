...
export class AppDetailsComponent {
  ...
  onPageLoadProductData(data) {
        ...
        this.addRegisterData = this.fb.group(
          {
            ...
            uatPort: [
              ...
              [
                Validators.required,
                Validators.pattern(
                  /^(?!(?:80[5-9][0-9]|80[5-9][0-9]|81[0-4][0-9]|8150)$)\d+$/
                )
              ]
            ],
            httpCertificate: [""],
          ...
          {
            validator: AccValidation.MatchAcc
          }
        );
      } else if (
        this.flowName ==
    ...
    this.addRegisterData.controls["uatPort"].setValue("443");
  ...
  data(data) {
    ...
    if (value === true) {
      ...
      this.summaryProductImage =
        config.url + "Images/Products/" + data.fileName;
      this.summaryProductName = data.productName;
      this.summaryProductDescription = data.description;
      this.selectedIndex1 = "";
  ...
  noAccountSubmission(details) {
    alert(
      "Thank You for Subscription.This information will help for Lead Generation !"
    );
            ...
            services: [
              {
                ...
                prodURL1: details.prodURL1,
                prodURL2: details.prodURL2,
                communicationProtocolProduction: this
                  .communicationProtocolProduction,
                serviceNameInputUAT: details.serviceNameInputUAT,
                serviceURLUAT: details.serviceURLUAT,
                serviceTimeOutUAT: details.serviceTimeOutUAT,
                serviceNameInputProd: details.serviceNameInputProd,
        ...
        if (
          ...
          if (this.prodFile1 === "" && this.prodFile2 === "") {
            ...
            this.appservice.uploadFile(this.projectId, formData1).then(data => {
              ...
              this.appservice
                .uploadFile(this.projectId, formData2)
                .then(data => {
                  //   console.log("data of file", data);
                });
            });
          ...
          if (this.prodFile1 === "") {
            ...
            //   console.log("this.proejctId", this.projectId);
            this.appservice
              .uploadFileProd(this.projectId, formData)
              .then(data => {
                //   console.log("data of file", data);
              });
          }
