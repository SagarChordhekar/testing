      ...
      if(this.summaryProductName == 'eCollections'){
        if(this.flowName == 'ECollection with Remitter Validation in Intermediary Account'){
          this.addRegisterData = this.fb.group({
            ...
            // ]),
            'organization': ['', [Validators.required,Validators.pattern(/^[a-zA-Z0-9][ a-zA-Z0-9&'._]+$/)]],
            'iciciAccNo': ['',[Validators.required,Validators.pattern(/^[0-9]{12}$/)]],
            'poolAccNo': ['',[Validators.required,Validators.pattern(/^[0-9]{12}$/)]],
            ...
            'emailIdITSpoc': ['', [ Validators.pattern(/^([a-zA-Z0-9]([a-zA-Z0-9_\.]{1,})?[a-zA-Z0-9])@([a-zA-Z0-9]([a-zA-Z0-9\-]{1,})?[a-zA-Z0-9])\.([a-zA-Z]{2,})(\.[a-zA-Z]{2,4})?$/)]],
            'webServiceType': [''],
            ...
            'uatPort': ['443', [Validators.required, Validators.pattern(/^(?!(?:80[5-9][0-9]|80[5-9][0-9]|81[0-4][0-9]|8150)$)\d+$/)]],
            'httpCertificate': [''],
            ...
            'prodPort': ['443', [ Validators.pattern(/^(?!(?:80[5-9][0-9]|80[5-9][0-9]|81[0-4][0-9]|8150)$)\d+$/)]],
            'httpProdCertificate': [''],  
...
console.log('details',details);
  ...
  if (this.invalid.length > 0) {
      ...
      if(this.invalid[i]=="hostNameUat"||this.invalid[i]=="uatIp"||this.invalid[i]=="uatPort"){
