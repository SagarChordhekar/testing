import {
 ...
 disableInput: any = true;
  ...
  this.actRoute.queryParams.subscribe((params) => {
    if (params.tab) {
      this.tab = params.tab;
      console.log("Tab property",this.tab);
      this.nextTab(this.tab);
      console.log("Move to Go Live");
  ...
  initiateProd(dataOFModal) {
    ...
    let navigationExtras: NavigationExtras = {
      queryParams: { 'projectId': this.queryparamProjectId }
      };
    this.router.navigate(['/authentication/user-profile'],navigationExtras);
